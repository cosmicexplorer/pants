...
from pants.contrib.go.targets.go_swagger_library import GoSwaggerLibrary
...
from pants.contrib.go.tasks.go_swagger_gen import GoSwaggerGen
...
def build_file_aliases():
  return BuildFileAliases(
    targets={
      ...
      GoSwaggerLibrary.alias(): GoSwaggerLibrary,
...
def register_goals():
  ...
  task(name='go-swagger', action=GoSwaggerGen).install('gen')
