...
class JvmPlatform(Subsystem):
  ...
  class _CompilerChoices(enum(['zinc', 'javac', 'rsc', 'scalac'])): pass
  ...
  def register_options(cls, register):
    ...
    register_enum_option(
      register, cls._CompilerChoices, '--compiler', default='zinc', advanced=True,
      help='Java compiler implementation to use.')

  def get_compiler_enum(self):
    return self._CompilerChoices.create(self.get_options().compiler)
