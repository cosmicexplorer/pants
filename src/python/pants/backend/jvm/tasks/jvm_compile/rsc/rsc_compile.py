...
class RscCompile(ScalacCompile):
    ...
    def work_for_vts_rsc(vts, ctx):
      ...
      if not hit_cache:
        ...
        with Timer() as timer:
          ...
          # TODO: move with_graal=False into ._get_jvm_distribution()?
  ...
  # execution requests.
  def _runtool_nonhermetic(self, parent_workunit, classpath, main, tool_name, args, distribution, **kwargs):
    try:
