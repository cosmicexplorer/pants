...
pub extern "C" fn scheduler_create(
  ...
  construct_materialized_directory: Function,
  type_directory_to_materialize: TypeId,
  type_materialized_directory: TypeId,
  type_address: TypeId,
  ...
  let types = Types {
    ...
    construct_materialized_directory: construct_materialized_directory,
    directory_to_materialize: type_directory_to_materialize,
    materialized_directory: type_materialized_directory,
